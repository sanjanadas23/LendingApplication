...
import com.aurionpro.lending.exception.DocumentUploadException;
...
import com.aurionpro.lending.repository.DocumentRepository;
...
public class DocumentServiceImpl implements DocumentService {
	...
	public List<DocumentResponseDTO> getDocumentsByCustomerId(int customerId) {
		...
		if (documents.isEmpty()) {
			throw new ResourceNotFoundException("No documents found for Customer ID: " + customerId);
		}
	...
	public List<DocumentResponseDTO> getDocumentsByLoanId(int loanId) {
		...
		if (documents.isEmpty()) {
			throw new ResourceNotFoundException("No documents found for Loan ID: " + loanId);
		}
		return documents.stream().map(this::toResponseDTO).collect(Collectors.toList());
	}
